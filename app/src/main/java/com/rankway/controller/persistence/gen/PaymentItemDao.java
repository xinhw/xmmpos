...
*/
public class PaymentItemDao extends AbstractDao<PaymentItem, Long> {
    ...
    private Query<PaymentItem> paymentTotal_DishTransRecordDatasQuery;
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, PaymentItem entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, PaymentItem entity) {
        stmt.clearBindings();
    ...
    @Override
    public PaymentItem readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, PaymentItem entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(PaymentItem entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(PaymentItem entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(PaymentItem entity) {
    ...
    public List<PaymentItem> _queryPaymentTotal_DishTransRecordDatas(long paymentTotalId) {
        synchronized (this) {
            if (paymentTotal_DishTransRecordDatasQuery == null) {
                QueryBuilder<PaymentItem> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.PaymentTotalId.eq(null));
                paymentTotal_DishTransRecordDatasQuery = queryBuilder.build();
            }
        }
        Query<PaymentItem> query = paymentTotal_DishTransRecordDatasQuery.forCurrentThread();
