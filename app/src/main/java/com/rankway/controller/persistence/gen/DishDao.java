...
public class DishDao extends AbstractDao<Dish, Long> {
    ...
    private Query<Dish> dishType_DishTransRecordDatasQuery;
    ...
    public List<Dish> _queryDishType_DishTransRecordDatas(long typeId) {
        synchronized (this) {
        ...
        Query<Dish> query = dishType_DishTransRecordDatasQuery.forCurrentThread();
