...
/** 
 * DAO for table "DISH_TYPE".
*/
public class DishTypeDao extends AbstractDao<DishType, Long> {

    public static final String TABLENAME = "DISH_TYPE";

    /**
     * Properties of entity DishType.<br/>
    ...
    public DishTypeDao(DaoConfig config) {
        super(config);
    }
    
    public DishTypeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DISH_TYPE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DISH_TYPE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DishType entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DishType entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(DishType entity) {
    ...
    @Override
    public DishType readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, DishType entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DishType entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(DishType entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(DishType entity) {
