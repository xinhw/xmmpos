...
public class DishEntityDao extends AbstractDao<DishEntity, Long> {
    ...
    public static class Properties {
        ...
        public final static Property SubTypeId = new Property(8, long.class, "subTypeId", false, "SUB_TYPE_ID");
        public final static Property DishSubTypeCode = new Property(9, String.class, "dishSubTypeCode", false, "DISH_SUB_TYPE_CODE");
        public final static Property DishSubTypeName = new Property(10, String.class, "dishSubTypeName", false, "DISH_SUB_TYPE_NAME");
        public final static Property Timestamp = new Property(11, long.class, "timestamp", false, "TIMESTAMP");
    }

    private Query<DishEntity> dishSubTypeEntity_DishsQuery;
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DISH_ENTITY\" (" + //
                ...
                "\"SUB_TYPE_ID\" INTEGER NOT NULL ," + // 8: subTypeId
                "\"DISH_SUB_TYPE_CODE\" TEXT," + // 9: dishSubTypeCode
                "\"DISH_SUB_TYPE_NAME\" TEXT," + // 10: dishSubTypeName
    ...
    public DishEntity readEntity(Cursor cursor, int offset) {
        DishEntity entity = new DishEntity( //
            ...
            cursor.getLong(offset + 8), // subTypeId
            cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9), // dishSubTypeCode
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // dishSubTypeName
    ...
    public void readEntity(Cursor cursor, DishEntity entity, int offset) {
        ...
        entity.setSubTypeId(cursor.getLong(offset + 8));
        entity.setDishSubTypeCode(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
        entity.setDishSubTypeName(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
    ...
    /** Internal query to resolve the "dishs" to-many relationship of DishSubTypeEntity. */
    public List<DishEntity> _queryDishSubTypeEntity_Dishs(long subTypeId) {
        synchronized (this) {
            if (dishSubTypeEntity_DishsQuery == null) {
                QueryBuilder<DishEntity> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.SubTypeId.eq(null));
                dishSubTypeEntity_DishsQuery = queryBuilder.build();
            }
        }
        Query<DishEntity> query = dishSubTypeEntity_DishsQuery.forCurrentThread();
