...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        DishTypeDao.createTable(db, ifNotExists);
        MessageDetailDao.createTable(db, ifNotExists);
        PaymentItemDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        DishTypeDao.dropTable(db, ifExists);
        MessageDetailDao.dropTable(db, ifExists);
        PaymentItemDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(DishTypeDao.class);
        registerDaoClass(MessageDetailDao.class);
        registerDaoClass(PaymentItemDao.class);
