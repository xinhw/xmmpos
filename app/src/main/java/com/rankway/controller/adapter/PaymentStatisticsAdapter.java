 ...
 * </pre>
 */
public class PaymentStatisticsAdapter
        extends RecyclerView.Adapter<PaymentStatisticsAdapter.PaymentRecordStatisticsViewHolder>{
    ...
    public PaymentStatisticsAdapter(Context context, List<PaymentStatisticsRecordEntity> records){
