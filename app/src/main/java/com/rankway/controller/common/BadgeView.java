...
public class BadgeView extends android.support.v7.widget.AppCompatTextView {
    ...
    public BadgeView(Context context, View target) {
        this(context, (AttributeSet)null, 16842884, target, 0);
    }

    public BadgeView(Context context, TabWidget target, int index) {
        this(context, (AttributeSet)null, 16842884, target, index);
    }

    public BadgeView(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, (View)null, 0);
    }
    ...
    public void show() {
        this.show(false, (Animation)null);
    }
    ...
    public void hide() {
        this.hide(false, (Animation)null);
    }
    ...
    public void toggle() {
        this.toggle(false, (Animation)null, (Animation)null);
    }
